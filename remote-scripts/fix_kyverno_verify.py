...
r = subprocess.run(
    ["kubectl", "get", "clusterpolicy", "verify-image-signatures", "--no-headers"], capture_output=True, text=True
)
...
r2 = subprocess.run(["kubectl", "apply", "-f", "/tmp/verify-images.yaml"], capture_output=True, text=True)
